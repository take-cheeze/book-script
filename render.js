...
fs.writeFileSync(`${__dirname}/index.html`, _.template(index_template)({'config': config}));
...
for (const l of config.libraries) {
  ...
  fs.writeFileSync(`${__dirname}/${l}.html`, _.template(library_template)({'books': parsed, 'library': l}));
}
